...
Measured against the source image at rest, excluding the two deliberately animated plants:

| metric                           | value          |
| -------------------------------- | -------------- |
| mean absolute error              | **0.10 / 255** |
| pixels differing by more than 8  | **0.001 %**    |
| pixels differing by more than 32 | **0.0001 %**   |
